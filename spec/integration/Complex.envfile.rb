environment(name: "Complex integration test environment", provider: :aws) do
  ...
  facet(name: "Database", cardinality: 3) do
    database_master(name: "Database Master", flavor: "c1.xlarge", database_provider: "postgres") do
    end
    facet(name: "Database Slaves", cardinality: 2) do
      database_slave(name: "Database Slave", flavor: "m1.large", database_provider: "postgres") do
